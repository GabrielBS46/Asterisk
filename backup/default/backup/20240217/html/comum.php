...
<div class="d-flex px-5">
	<h2 class="text-light"><i class="fas fa-asterisk"></i>&nbsp;&nbsp;Server <?php echo gethostname();?></h2>
</div>
</header>
	...
	<div class="collapse navbar-collapse" id="main_nav">
		<ul class="navbar-nav">
			...
			<li class="nav-item dropdown">
				...
				<li><a class="dropdown-item" href="formularioCriaRamal.php">Criar Ramais</a></li>
		...
		<li class="nav-item dropdown">
			...
			<li class="nav-item dropdown">
				...
				<li><a class="dropdown-item" href="formularioGraficoTotAnsBusNoans.php">Grafico  por ramal</a></li>
					...
					<li class="nav-item dropdown">
				<a class="nav-link  dropdown-toggle active" href="#" data-toggle="dropdown"><i class="fas fa-user"></i></i>&nbsp;&nbsp;Usuários </a>
				<ul class="dropdown-menu">
				  <h6 class="dropdown-header drop-header-color text-white" >Usuários</h6>
				  <li><a class="dropdown-item" href="formularioCriaUsuario.php">Criar Usuário</a></li>
				  <li><a class="dropdown-item" href="formularioEndUsuarioEdit.php">Editar Usuário</a></li>
				  <li><a class="dropdown-item" href="formularioDelUsuario.php">Excluir Usuário</a></li>
				</ul>
			</li>
...
<?php
	if (isset($_GET['success']))  // dados recebidos de para validar a remocao do Usuário
		echo "SUCESSO";
		echo $_POST['msg'];
	if (isset($_GET['fail']))
		echo "FALHA";
